<<<<<<< Updated upstream:P01-JAM/Development/Sprint-2/JAM/src/routes/hostOrPlayer/+page.svelte
<script lang="js">
  // @ts-nocheck
...
>>>>>>> Stashed changes:P01-namePending/Development/Sprint-2/JAM/src/routes/hostOrPlayer/+page.svelte
