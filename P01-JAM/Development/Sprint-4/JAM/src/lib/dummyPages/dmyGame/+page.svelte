<script>
  ...
  let svg = "https://www.svgrepo.com/show/528669/star-circle.svg";
...
<div
  class="flex justify-center items-center space-x-2 overflow-auto py-4 bg-gradient-to-r from-purple-900 via-purple-700 to-purple-500 fixed top-0 w-full z-20 shadow-lg font-garamond text-sm"
>
  <button
  ...
  <button
    class="bg-gradient-to-r from-purple-700 to-purple-900 hover:from-purple-600 hover:to-purple-800 text-white font-bold py-2 px-4 rounded-full transition duration-300 transform hover:scale-105 shadow-lg focus:outline-none focus:ring focus:ring-purple-500 focus:ring-opacity-50"
    on:click={() => {
      showQuestionOnPlayerDisplay = !showQuestionOnPlayerDisplay;
    }}>Toggle Question Display</button
  >
</div>
...
{:else}
  <div
    class="relative min-h-screen {selectedBgColor} text-white flex justify-center items-center"
  >
              ...
              <div class="bg-purple-900 p-6 rounded-lg shadow-lg w-full">
                ...
                {#if quiz.quiz[currentQuestion].imageUrl}
                  <img
                    ...
                    alt="img"
                    class="mx-auto h-auto rounded-md mb-4"
                  />
                {/if}
                ...
                <div class="flex justify-around mt-10">
                  <button
                    class="px-4 py-2 h-15 w-2/6 font-bold text-white bg-purple-600 rounded-full hover:bg-purple-700 focus:outline-none focus:shadow-outline transition duration-300 transform hover:scale-105 shadow-lg"
                    on:click={() => {}}
                  >
                    {isPaused ? "Resume" : "Pause"}
                  </button>
                  <button
                    class="px-4 py-2 h-15 w-2/6 font-bold text-white bg-gray-500 rounded-full hover:bg-gray-600 focus:outline-none focus:shadow-outline transition duration-300 transform hover:scale-105 shadow-lg"
                    on:click={() => {
                      goto("/hostOrPlayer");
                    }}
                  >
