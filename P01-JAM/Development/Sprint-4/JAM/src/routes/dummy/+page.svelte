...
// @ts-nocheck
    ...
    import DmyBg from '$lib/dummyPages/dmyBg/+page.svelte'
    import DmyBg2 from '$lib/dummyPages/dmyBg2/+page.svelte'
    import DmyBg3 from '$lib/dummyPages/dmyBg3/+page.svelte'
